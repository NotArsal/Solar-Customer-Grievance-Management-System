...
export default function ThemeToggle() {
    const [darkMode, setDarkMode] = useState(() => {
        // Init from local storage or document class if available to avoid out of sync
    ...
    return (
        <Spin 
            ...
            className="p-2 rounded hover:bg-gray-100 text-brand-text dark:text-gray-300 dark:hover:bg-gray-800 transition-colors" 
        />
    );
}
